...
\begin{axis}[
    ...
    y=depth_m,
    row predicate/.code={
        \pgfmathparse{mod(\coordindex,10)}
        \ifnum\pgfmathresult=0\relax\else\pgfplotstableuserowfalse\fi
    }
] {figures/results/profile_20m.csv};
\end{axis}
\end{tikzpicture}
...
] {figures/results/profile_50m.csv};
\end{axis}
\end{tikzpicture}
...
] {figures/results/profile_90m.csv};
\end{axis}
\end{tikzpicture}
