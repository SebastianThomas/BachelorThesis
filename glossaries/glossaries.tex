...
Decompression is primarily the process of releasing bound gas from the tissues through breathing a gas that has a lower \gls{pp} of that gas than currently present in some tissue.
...
\newacronym{otu}{OTU}{Oxygen Toxicity Unit (percent of the CNS Clock)}
