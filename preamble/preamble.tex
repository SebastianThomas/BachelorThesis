...
\title{\misspar{Linear-Exponential Algorithm-based Open-Source Dive Computer}}%
\author{Sebastian Thomas}%
\date{June 2026}%

% Define a command for setting the semester on the titlepage.
\def\@semester{Spring Semester 2026}%
...
\def\@email{tsebastian@student.ethz.ch}%
...
\def\@firstsup{Tommaso Polonelli}%
...
\def\@professor{Prof. Dr. Luca Benini}%
